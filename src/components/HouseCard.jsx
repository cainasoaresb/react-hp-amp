...
const HouseCard = ({ house }) => {
  ...
  const houseEmblems = {
    'Gryffindor': GryffindorAltEmblem,
    'Ravenclaw': RavenclawAltEmblem,
    'Hufflepuff': HufflepuffAltEmblem,
    'Slytherin': SlytherinAltEmblem,
  };

  const emblemAltSrc = house ? houseEmblems[name] : null;
